            ...
            <div className={cn(
              ...
              <Button
                ...
                className={cn(
                  ...
                  collapsed && "px-2",
                  state.network === 'Preprod' && "bg-[#FFF] dark:bg-background hover:bg-[#FFF] dark:hover:bg-background"
                )}
              ...
              <Button
                ...
                className={cn(
                  "flex-1 font-medium hover:bg-[#FFF0] hover:scale-[1.1] transition-all duration-300",
                  collapsed && "px-2",
                  state.network === 'Mainnet' && "bg-[#FFF] dark:bg-background hover:bg-[#FFF] dark:hover:bg-background"
                )}
