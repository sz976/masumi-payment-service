import { OnChainState, PurchaseErrorType, PurchasingAction, TransactionStatus, } from "@prisma/client";
                        ...
                        where: { id: request.id }, data: {
                            NextAction: {
                                update: {
                                    ...
                                    errorNote: "Cancelling refund failed: " + convertErrorString(error),
                                }
                            },
                            SmartContractWallet: {
                                update: {
