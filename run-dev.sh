...
echo -e "${BLUE}=========================================================${NC}"
echo -e "${BLUE}   Masumi Payment Service - Development Setup            ${NC}"
echo -e "${BLUE}=========================================================${NC}"
...
echo -e "\n${YELLOW}Step 1: Creating .env file with secure random values (DEVELOPMENT)${NC}"
...
COMPOSE_PROJECT_NAME=masumi_payment_dev

# Database settings
POSTGRES_PASSWORD=${POSTGRES_PASSWORD}
DATABASE_URL=postgresql://masumi:${POSTGRES_PASSWORD}@postgres:5432/masumi_payment_dev?schema=public
SHADOW_DATABASE_URL=postgresql://masumi:${POSTGRES_PASSWORD}@postgres:5432/masumi_payment_dev_shadow?schema=public
...
BATCH_PAYMENT_INTERVAL=120
CHECK_COLLECTION_INTERVAL=150
CHECK_TX_INTERVAL=90
CHECK_COLLECT_REFUND_INTERVAL=150
CHECK_SET_REFUND_INTERVAL=150
CHECK_UNSET_REFUND_INTERVAL=150
CHECK_AUTHORIZE_REFUND_INTERVAL=150
CHECK_SUBMIT_RESULT_INTERVAL=150
CHECK_WALLET_TRANSACTION_HASH_INTERVAL=30
REGISTER_AGENT_INTERVAL=150
DEREGISTER_AGENT_INTERVAL=150
EOL

echo -e "${GREEN}Created .env file with secure random values for development environment.${NC}"

# Step 2: Handle SSL certificates
echo -e "\n${YELLOW}Step 2: Setting up SSL certificates for NGINX (DEVELOPMENT)${NC}"
...
echo -e "\n${YELLOW}Step 3: Creating necessary directories (DEVELOPMENT)${NC}"
...
echo -e "\n${YELLOW}Step 5: Wallet Configuration Status (DEVELOPMENT)${NC}"
...
echo -e "  - .env (with secure random credentials for development)"
